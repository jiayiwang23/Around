...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	//get url by call save to gcs, we need file(content) and header(property)
	file, header, err := r.FormFile("image") //the image result need to be form
	if err != nil {
	...
	//we need get a uri and then call annotate
	if p.Type == "image" {
